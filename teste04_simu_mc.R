...
R     <- 100           # número de réplicas de Monte Carlo (reduza p/ testar mais rápido)
beta0 <- 1
beta1 <- 0.5
beta2 <- -0.1
...
for (phi_val in phis) {
  ...
  cat("phi =", phi_val, "->", n_validas, "de", R, "réplicas convergiram\n")
}
